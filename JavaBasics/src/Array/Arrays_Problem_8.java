...
public class Arrays_Problem_8 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Student Name"+"\t\t"+ Student_Name[0]+"\t\t"+ Student_Name[1]+"\t"+ Student_Name[2]+"\t"+Student_Name[3]+"\t"+Student_Name[4]);
		System.out.println("Gender  "+"\t\t"+ Gender[0]+"\t\t"+ Gender[1]+"\t\t"+ Gender[2]+"\t\t"+Gender[3]+"\t\t"+Gender[4]);
		System.out.println("Mobile Number  "+"\t\t"+ Mobile_Number[0]+"\t\t"+ Mobile_Number[1]+"\t\t"+ Mobile_Number[2]+"\t\t"+Mobile_Number[3]+"\t\t"+Gender[4]);
		System.out.println("Roll No  "+"\t\t"+ Roll_No[0]+"\t\t"+ Roll_No[1]+"\t\t"+ Roll_No[2]+"\t\t"+Roll_No[3]+"\t\t"+Roll_No[4]);
		System.out.println();
